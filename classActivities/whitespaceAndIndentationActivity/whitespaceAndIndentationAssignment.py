...
let favoriteNumber = input("what is your favorite number ")

const computerFavRan = 
random.randint
    (1,100)
...
else if(computerFinalResponse == False){
  print("Thank you {0} for playing.
   Next time i hope my favorite number of {1} is in range".format(userInput, computerFavRan))
}
